...
<WebServiceRequestEntity>
   ...
   <restUrl>${auUrl}${auSchAs}${opt}?locationFoundOptions=true&amp;conditionOptions=true&amp;statusOptions=true&amp;modelOptions=true&amp;brandOptions=true&amp;nameOptions=true&amp;task=</restUrl>
