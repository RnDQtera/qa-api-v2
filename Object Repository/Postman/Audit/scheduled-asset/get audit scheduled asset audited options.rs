...
<WebServiceRequestEntity>
   ...
   <restUrl>${auUrl}${auSchAs}audited${opt}?locationFoundOptions=true&amp;conditionOptions=true&amp;statusOptions=true&amp;modelOptions=true&amp;brandOptions=true&amp;nameOptions=true&amp;task=</restUrl>
