...
<WebServiceRequestEntity>
   ...
   <name>Get RFID QR Reported List Options</name>
   <tag></tag>
   <elementGuidId>1f10e197-a09e-4e53-9407-2c6803ad457b</elementGuidId>
   ...
   <restUrl>${tagUrl}${rep}rfid-qr/options?assetNameOptions=true</restUrl>
