...
<WebServiceRequestEntity>
   ...
   <name>Pending Changes Asset Name List</name>
   <tag></tag>
   <elementGuidId>0de9c9d0-2cda-4557-b8e7-5bfaf8654dfc</elementGuidId>
   ...
   <restUrl>${tagUrl}${penChng}/asset-name-list?type=Change to RFID</restUrl>
