...
<WebServiceRequestEntity>
   ...
   <name>Get Asset Detail by Tag</name>
   <tag></tag>
   <elementGuidId>0bbc2fe0-bc39-40a4-8efa-163364d4d1c0</elementGuidId>
   ...
   <httpHeaderProperties>
      ...
      <webElementGuid>3eab49fb-4cbe-4d8e-a64d-a428e6a37be7</webElementGuid>
   </httpHeaderProperties>
   ...
   <restUrl>${assUrl}${ass}scan?tag=C000V2k9UbvV</restUrl>
