...
<WebServiceRequestEntity>
   ...
   <name>get task event log list</name>
   <tag></tag>
   <elementGuidId>7ba56b93-0453-4ac8-8bbf-c75d1fde34ec</elementGuidId>
   ...
   <httpHeaderProperties>
      ...
      <webElementGuid>dc09c7fa-7754-46f5-adb7-1f801a690de4</webElementGuid>
   </httpHeaderProperties>
   ...
   <restUrl>${rutUrl}${rutTask}event-log</restUrl>
